...
function Cards({
	...
	return (
		<div
			className={`cards-container ${isFinished ? "completed" : "notcompleted"}`}
		>
			<Link
				to={{
					pathname: "/detail",
					...
					<div className='btn-co2'>
						{!isFinished ? (
							<button
								...
								onClick={(e) =>
									completed(
										books?.primary_isbn10 ||
											books?.isbns[0].isbn10 ||
											books.isbn13[0]
									)
								}
							>
			...
			<div className='like icon'>
				{isfav ? (
					...
					>
						<img
							alt='X'
							src='https://img.icons8.com/external-kiranshastry-lineal-color-kiranshastry/64/000000/external-close-banking-and-finance-kiranshastry-lineal-color-kiranshastry.png'
						/>
					</button>
				) : (
					<img
						...
						src={
							islike
								? "https://img.icons8.com/color/48/000000/like--v3.png"
								: "https://img.icons8.com/ios-glyphs/24/000000/like--v2.png"
						}
						alt='like'
					/>
				)}
