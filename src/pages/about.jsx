...
function about() {
    return (
        <div className="about-container" id="about">
            ...
            <div className="paragraph">Reading books is crucial in our life but sometimes, We are not sure what book we have to read or not. Here is the book hunter shine.
Book Hunter introduces good books with proper ratings, reviews and your category, so that you can find the perfect one for your taste. Also you can share your favorite book so other people can read it too.
